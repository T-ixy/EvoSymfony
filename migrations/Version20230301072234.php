 ...
 */
final class Version20230301072234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, category VARCHAR(255) NOT NULL, icone_url VARCHAR(255) NOT NULL, color INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formations (id INT AUTO_INCREMENT NOT NULL, sanction_id INT DEFAULT NULL, university_id INT NOT NULL, title VARCHAR(255) NOT NULL, generality LONGTEXT NOT NULL, prerequisite LONGTEXT DEFAULT NULL, purpose LONGTEXT NOT NULL, finality LONGTEXT DEFAULT NULL, contents LONGTEXT NOT NULL, prices INT DEFAULT NULL, duration VARCHAR(255) NOT NULL, priority TINYINT(1) NOT NULL, vignette_url VARCHAR(255) NOT NULL, INDEX IDX_4090213796E0C11A (sanction_id), INDEX IDX_40902137309D1878 (university_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE universities (id INT AUTO_INCREMENT NOT NULL, university VARCHAR(255) NOT NULL, logo_url VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
